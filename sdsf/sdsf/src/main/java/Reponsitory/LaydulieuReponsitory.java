...
public class LaydulieuReponsitory implements Thaotac {
	@Override
	   public void updateAvatar(int maNguoiDung, String avatarPath) {
	        ...
	        try {
	            ...
	            String sql = "UPDATE Users SET avatar = ? WHERE maNguoiDung = ?";
	            ...
	            System.out.println("Lỗi khi cập nhật avatar người dùng");
	            e.printStackTrace();
	        } finally {
	            try {
	                if (ps != null) ps.close();
